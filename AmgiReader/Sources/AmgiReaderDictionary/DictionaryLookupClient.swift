...
/// DI surface for offline dictionary lookups: async lookup with a
/// scan-length window, media-file resolver for dictionary-bundled
/// images/audio, and library management (import / enable / delete).
@DependencyClient
