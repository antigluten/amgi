...
public struct TagClient: Sendable {
    ...
    public var addTagToNotes: @Sendable (_ tag: String, _ noteIDs: [NoteID]) throws -> Void
    public var removeTagFromNotes: @Sendable (_ tag: String, _ noteIDs: [NoteID]) throws -> Void
    ...
    public var findNotesByTag: @Sendable (_ tag: String) throws -> [NoteID]
}
